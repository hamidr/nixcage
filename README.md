...
| `nixcage-container veth <name>`, `lib.vethHostName` | The host end of the cage's veth on a bridge placement, a function of its name, for the host's rules to key on at run time or at build time (ADR-013) |
